        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> New Social&nbsp;&nbsp;
                    ...
                    >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 col-sm-8">
                                <input type="text" autofocus name="url" id="url" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 col-sm-10">
                                <input type="file" name="icon" required id="icon" accept="image/*" onchange="loadFile(event)">
                            </div>
                        </div>
                        <div class="form-group row">
