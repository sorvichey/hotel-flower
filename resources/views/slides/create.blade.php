            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    >
                        ...
                        <div class="form-group row">
                            <label for="photo" class="control-label col-lg-2 col-sm-2">Image <span class="text-info">(1280 x 500)</span> <span class="text-danger">*</span></label>
                            <div class="col-lg-6 col-sm-8">
